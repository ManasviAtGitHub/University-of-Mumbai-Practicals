 ...
 * 
 */
@WebServiceClient(name = "BillingService", targetNamespace = "http://billing/", wsdlLocation = "http://localhost:9001/Billing?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BILLINGSERVICE_QNAME = new QName("http://billing/", "BillingService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9001/Billing?wsdl");
    ...
    public Billing getBillingPort() {
        return super.getPort(new QName("http://billing/", "BillingPort"), Billing.class);
    }
    ...
    public Billing getBillingPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://billing/", "BillingPort"), Billing.class, features);
    }
